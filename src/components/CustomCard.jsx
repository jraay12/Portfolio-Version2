...
const CustomCard = ({
  ...
  return (
    <div className="relative w-full  font-robot bg-secondary/10 shadow-md rounded-lg p-4 hover:scale-110 transition duration-300 cursor-pointer" data-aos="fade-up" data-aos-delay="50">
      {/* icon container */}
      ...
      <p className="mt-16 text-2xl font-bold uppercase  font-robot">
        {ProjectName}{" "}
        <span className="text-xs text-black underline underline-offset-2">{`${Freelance ? "Freelance" : "Personal Project"}`}</span>
      </p>
