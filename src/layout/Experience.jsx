...
const Experience = () => {
  return (
    <div id="experience" className="lg:max-w-[1536px] mx-auto mt-20  font-vt323 p-10">
      <p className="text-5xl font-bold text-shadow-lg text-secondary">Experience</p>
      <p className=" mt-2 text-secondary">_What experience do I bring?</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 mt-10 mb-10">
